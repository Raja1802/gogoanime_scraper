...
class AjarPipeline(object):
    ...
    def create_table(self):
        self.curr.execute("""DROP TABLE IF EXISTS gogoanime_all_3""")
        self.curr.execute("""create table gogoanime_all_3(
                             episode text,
                             name_anime text,
                             download_url text,
    ...
    def store_db(self, item):
        self.curr.execute("""insert into gogoanime_all_3 values (%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s)""", (
            ''.join(item['episode']),
